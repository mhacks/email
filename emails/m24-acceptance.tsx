    ...
    <EmailProvider preview={CONFIRM_TEXT}>
      ...
      <Section>
        ...
        <Section>
          ...
          <Text style={textP}>
            ...
            <b>
              Duo Security, one of the fastest-growing cybersecurity providers
              in the world
            </b>
            . Song is also the co-founder and president of The Song Foundation
            and a board member of the National Advisory Council on Innovation
            and Entrepreneurship.
          </Text>

          <Text style={textP}>
            In 2018, <b>Duo was acquired by Cisco for $2.35 billion</b>, making
            it the largest exit ever for a Michigan-based software company. Song
            is a renowned hacker and leading voice in the information security
            industry. He is often quoted on cybersecurity issues by
            international media and appears onstage at industry events around
            the world.
          </Text>
      ...
      <Section>
        ...
        <Text style={textP}>
          ...
          travel recommendations, prizes, and more. This will be coming within
          the next day.
        </Text>
      </Section>
      ...
      <Section>
        ...
        <Text style={textP}>
          We hope you're excited for MHacks 2024 and we look forward to seeing
          you there!
        </Text>
