      ...
      <GmailWrapper>
        <Container style={container}>
          <Section>
            ...
            <Text style={paragraph}>
              If you opt in, you won’t be eligible for prizes from other tracks
              or sponsors, so this track isn’t for most hackers. But,{' '}
              <b>
                if you’re currently starting a startup or working on a project
                that could turn into one
              </b>
